...
module.exports = function(server, mocker) {
  ...
  server.route({
    ...
    handler: ensureInitialized(function(request, reply) {
      reply = wrapReply(request, reply);
      require('./api/reset-input')(mocker)(request, reply);
    })
  });
  ...
  server.route({
    ...
    handler: ensureInitialized(function(request, reply) {
      reply = wrapReply(request, reply);
      require('./api/global-input')(mocker)(request, reply);
    })
  });
  ...
  server.route({
    ...
    handler: ensureInitialized(function(request, reply) {
      reply = wrapReply(request, reply);
      require('./api/set-proxy')(mocker)(request, reply);
    })
  });
  ...
  server.route({
    ...
    handler: ensureInitialized(function(request, reply) {
      reply = wrapReply(request, reply);
      require('./api/har-display')(mocker)(request, reply);
    })
  });
