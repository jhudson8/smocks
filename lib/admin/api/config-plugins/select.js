...
\n\
      return React.createElement(ConfigItemWrapper, { id: this.props.id, label: this.props.label },\n\
        React.DOM.select({ id: this.props.id, className: "ui dropdown", name: this.props.id, defaultValue: this.props.value,\n\
