  ...
  render: function() {
    ...
    var nav = (
      <ul className="nav nav-tabs">
        <li role="presentation" className={viewScope === 'fixtures' && 'active'}>
          <a href="#" onClick={this.showFixtures}>Fixtures</a>
        </li>
        <li role="presentation" className={viewScope === 'config' && 'active'}>
          <a href="#" onClick={this.showConfig}>Configuration</a>
        </li>
        <li role="presentation" className={viewScope === 'har' && 'active'}>
          <a href="#" onClick={this.showHar}>HAR Replay</a>
        </li>
      </ul>
    );
...
var Variant = React.createClass({
  ...
  render: function() {
    ...
    return <li className={'variant' + (selected ? ' selected' : '')}>
      <input type="radio" id={id} checked={selected} onChange={this.onChange}/>
...
var ConfigList = React.createClass({
  ...
  render: function() {
    ...
    return <form className="config-list">{children}</form>;
  }
});
