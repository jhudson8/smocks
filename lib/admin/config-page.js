...
var AdminPage = React.createClass({
  ...
  getInitialState: function() {
    return { filter: '', viewType: 'label', viewScope: 'fixtures', 'profileState': _.uniqueId('profileState-') };
  },
    ...
    if (viewScope === 'config') {
      ...
      return React.DOM.div({},
        React.DOM.div({className: 'info'},
          React.DOM.input({className: 'route-filter form-control', onChange: this.onFilter, placeholder: 'Filter'}),
          React.DOM.form({className: 'display-selector'},
            ...
            React.createElement(DisplaySelectorChoice, {label: 'Path', selected: viewType === 'route', onSelect: this.onRouteViewType})
          ),
