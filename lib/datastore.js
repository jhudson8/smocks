...
/*
  function prepareData (item, store, domain, joins) {
    if (joins.length === 0) {
      return item;
    }
...
*/
  ...
  function ListResult (value, options, data) {
    this._value = value || [];
    this._data = data || {};
  ...
  Object.assign(ListResult.prototype, {
    filter: function (criteria) {
      ...
      return new ListResult(results, this.options, this._data);
    },
    ...
    limit: function (offset, size) {
      ...
      return new ListResult(this._value.slice(offset, size ? offset + size : undefined), this.options, this._data);
    },
